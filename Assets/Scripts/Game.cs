...
public class Game {
	...
	public void NewGame() {
		...
		_cardsInHeap.Add (new CardToBuild(TopCardFeature.ResourceConstClay, 1, BottomCardFeature.PeopleMultiplier, 2));
		...
		_cardsInHeap.Add (new CardToBuild(TopCardFeature.ResourceConstStone, 1, BottomCardFeature.PeopleMultiplier, 1));
		...
		_cardsInHeap.Add (new CardToBuild(TopCardFeature.ResourceConstGold, 1, BottomCardFeature.PeopleMultiplier, 1));
		...
		_cardsInHeap.Add (new CardToBuild(TopCardFeature.ResourceRandomForest, 2, BottomCardFeature.PeopleMultiplier, 2));
		...
		_cardsInHeap.Add (new CardToBuild(TopCardFeature.Score, 3, BottomCardFeature.Science, Science.Music));
		_cardsInHeap.Add (new CardToBuild(TopCardFeature.ResourceRandomStone, 2, BottomCardFeature.PeopleMultiplier, 1));
