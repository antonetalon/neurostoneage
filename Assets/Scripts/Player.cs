...
public class Player {
	...
	public void ApplyCardTopRandomToAllSelection(int selection) {
		switch (selection) {
			case 1: AddResource (Resource.Forest); break;
			case 2: AddResource (Resource.Clay); break;
			case 3: AddResource (Resource.Stone); break;
			case 4: AddResource (Resource.Gold); break;
