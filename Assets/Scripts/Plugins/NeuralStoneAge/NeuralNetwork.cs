...
namespace NeuralStoneAge
{
    ...
    public class NeuralNetwork
    {
        ...
        [NonSerialized] double[][] _neuronOutputs;
        [NonSerialized] double[][] _neuronInputs;
        ...
        #region Backward propagation training
        ...
        [NonSerialized] private double[][] _sigmas;
        #endregion
        ...
        [NonSerialized] private int _complexity;
        /// <summary>
        /// This is just connections count to have a overall representation of this network computational complexity.
        /// </summary>
